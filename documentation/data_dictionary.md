...
| Unit_Price | Decimal | Price of one unit | Yes | No | 4,500.00 | Must be greater than 0. Must match with given unit price in Products table| No | Sales data | - |
| Total_Amount | Decimal | Total transaction value | Yes | No | 6,000.00 | Must be greater than 0 and equal to Quantity * Unit_Price | No | Sales data | - |
